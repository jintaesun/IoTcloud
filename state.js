...
var invokeAPI = function() {
    ...
    var API_URI = 'https://4x0krowu93.execute-api.ap-northeast-2.amazonaws.com/prod/my-resource?myParam=yun';                 
    $.ajax(API_URI, {
        method: 'GET',
...
var printData = function(result){      
    document.getElementById("result").innerHTML = "temp: " + myParam ;